...
<template>
  <el-form-item :label="$t('labels.container_image')" prop="containerImage">
    <el-row></el-row>
    <el-row>
      <!-- レジストリの選択 -->
      <el-col :span="6" :offset="1">{{ $t('labels.registry') }}</el-col>
      <el-col :span="12">
        <el-select
          size="small"
          filterable
    ...
    <el-row>
      <!-- イメージの選択 -->
      <el-col :span="6" :offset="1">{{ $t('labels.image') }}</el-col>
      <el-col :span="12">
        <el-select
          :value="value.image"
          size="small"
    ...
    <el-row>
      <!-- タグの選択 -->
      <el-col :span="6" :offset="1">{{ $t('labels.tag') }}</el-col>
      <el-col :span="12">
        <el-select
          :value="value.tag"
          size="small"
