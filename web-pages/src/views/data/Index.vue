<template>
  <div>
    <h2>{{ $t('titles.data_management') }}</h2>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column
          ...
          width="auto"
        />
        <el-table-column :label="$t('labels.parent_data_name')" width="120px">
        ...
        <el-table-column
          ...
          width="200px"
        />
        <el-table-column :label="$t('labels.created_by')" width="120px">
...
export default {
  title() {
    return this.$t('titles.data_management')
  },
  components: {
    KqiPagination,
    KqiSmartSearchInput,
